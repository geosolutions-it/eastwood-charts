 ...
 * 14-Jul-2008 : Changed default axis range to 0.0 - 1.0 to match data (DG);
 * 15-Jul-2008 : Added accessor methods for labelling axis range (DG);
 * 15-Jul-2008 : Fixed explicit label positioning (DG);
 *
 */
...
class GValueAxis extends NumberAxis implements GLabelledAxis {
	 ...
	 * are explicitly set.
	 */
	private NumberAxis axisForAutoLabels;
